...
const MovieCard = ({ movie, toggleFavorite, toggleWatchLater })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative group border-teal border-2 rounded-lg overflow-hidden h-[45vh]",
        children: [
...
function FavoritesPage() {
    ...
    const toggleFavorite = (movieId)=>{
        setFavorites((prevFavorites)=>prevFavorites.filter((movie)=>movie.id !== movieId) // Remove the movie from the list on unlike
        );
    };
...
//# sourceMappingURL=app_4fedd4._.js.map