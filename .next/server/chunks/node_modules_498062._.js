...
"[project]/node_modules/@vercel/postgres-kysely/dist/index.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
// src/index.ts
var VercelPostgresAdapter = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$dialect$2f$postgres$2f$postgres$2d$adapter$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PostgresAdapter"] {
    constructor(){
        super(...arguments);
        // represented as readonly property to satisfy eslint rule:
        // typescript-eslint/class-literal-property-style
        this._supportsTransactionalDdl = false;
    }
    get supportsTransactionalDdl() {
        return this._supportsTransactionalDdl;
    }
};
var VercelPostgresDialect = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$dialect$2f$postgres$2f$postgres$2d$dialect$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PostgresDialect"] {
    constructor(config){
        super(config);
        this.config = config;
    }
...
var VercelPostgresPoolDriver = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$dialect$2f$postgres$2f$postgres$2d$driver$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PostgresDriver"] {
        ...
        return new Proxy(connection, {
            get (target, p) {
                ...
                if (p === "streamQuery" && typeof original === "function") {
                    throw new VercelPostgresKyselyError("kysely_streaming_not_supported", "Streaming is not supported yet.");
                }
    ...
    beginTransaction() {
        throw new VercelPostgresKyselyError("kysely_transactions_not_supported", "Transactions are not supported yet.");
    }
    commitTransaction() {
        throw new VercelPostgresKyselyError("kysely_transactions_not_supported", "Transactions are not supported yet.");
    }
...
function createKysely(poolConfig, kyselyConfig) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$kysely$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Kysely"]({
        ...kyselyConfig,
        dialect: new VercelPostgresDialect({
            ...poolConfig,
            pool: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$postgres$2f$dist$2f$chunk$2d$7IR77QAQ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createPool"])(poolConfig)
        })
    });
}
;
...
//# sourceMappingURL=node_modules_498062._.js.map