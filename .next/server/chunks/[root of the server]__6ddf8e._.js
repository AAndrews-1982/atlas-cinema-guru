...
"[project]/app/api/titles/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
// Utility functions
const parseQueryParams = async (params)=>{
    const defaultGenres = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchGenres"])();
    return {
...
const validateParams = (params)=>{
    ...
    if (isNaN(params.minYear) || params.minYear < 0) {
        return {
            isValid: false,
            error: "Invalid minimum year"
        };
    }
    if (isNaN(params.maxYear) || params.maxYear > CURRENT_YEAR) {
        return {
            isValid: false,
            error: "Invalid maximum year"
        };
    }
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"])(async (req)=>{
    // Auth check
    ...
    try {
        ...
        // Fetch titles
        const titles = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchTitles"])(params.page, params.minYear, params.maxYear, params.query, params.genres, session.user.email);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            title: titles,
            metadata: {
                page: params.page,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6ddf8e._.js.map